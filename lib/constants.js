...
exports.OPTIONS = [
	{
		...
		short: 'i',
		type: 'string',
		description: 'Defines the interface on which to listen to. default value = \'any\'',
	...
	},
	{
		...
		short: 'f',
		type: 'string',
		description: 'Defines the filter to be applied on the interface. default value = \'ip proto\\tcp\'',
